...
__thread float fe[256];
__thread float fn[128];
__thread int32_t hz;
__thread uint32_t iz;
__thread uint32_t jcong = 234567891;
__thread uint32_t jsr = 123456789;
__thread uint32_t jz;
__thread uint32_t ke[256];
__thread uint32_t kn[128];
__thread uint32_t w = 345678912;
__thread float we[256];
__thread float wn[128];
__thread uint32_t z = 456789123;
